...
export default function ({title, poster, rating}) {
  ...
  return (
    <div className={`relative bg-cover bg-center h-[230px] min-w-[195px] rounded-xl  border-neutral-60 border group hover:scale-105 overflow-hidden transition-all`} 
     style={{
